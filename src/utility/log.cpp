...
const char fsBeginCh = '<';
const char fsSeperatorCh = ',';
const char fsEndCh = '>';

std::map<std::string, std::string> m_formatMap;
std::string m_log;
...
void log(int ec, const char* fmt, va_list args) {
...
void logGeneric(const char* fmt, ...) {
	va_list args;
...
void logError(int ec, const char* fmt, ...) {
	va_list args;
